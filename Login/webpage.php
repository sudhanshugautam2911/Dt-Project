  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand d-flex mx-1 " href="#" style="padding-top: 12px;padding-bottom: 0px;">
        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="26" fill="currentColor" class="bi bi-clipboard2-data"
          viewBox="0 0 16 16">
          <path
      ...
      <div class="collapse navbar-collapse d-flex justify-content-between " id="navbarSupportedContent">
        ...
        <input class="form-control form-control-dark w-100 d-grid gap-2 d-md-block  mx-1" type="text"
          placeholder="Search" aria-label="Search">

        <form method="post" action="logout.php" class="d-flex" id="logout">
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark" href="student/index.html">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body d-flex justify-content-center alignitems-center container-fluid">
                      ...
                      <ul class="nav col-md-5 justify-content-end list-unstyled d-flex">
                        <li class="ms-3"><a class="" href="https://twitter.com/Vishal44495963" target="_blank"><svg
                        ...
                        <li class="ms-3"><a class="text-danger" href="https://www.instagram.com/vishal.k.26/"
                            target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="29" height="29"
                        ...
                        <li class="ms-3"><a class="text-primary" href="https://www.facebook.com/vishal988k/"
                            target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29"
                    ...
                    <div class="modal-footer py-0 my-0">
                      <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Never
                        Mind</button>
        ...
        <img src="dashboard.jpg" class="d-flex justify-content-center align-items-center " style="padding-left: 2px; width: 1100px; height:400px"
          alt="">
